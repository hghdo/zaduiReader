...
public class AppSettings extends PreferenceActivity implements OnSharedPreferenceChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		values=this.getResources().getStringArray(R.array.image_quality_values);
		sv=Settings.getStringPreferenceValue(this, Settings.PRE_IMAGE_QUALITY, Settings.DEF_IMAGE_QUALITY);
		...
		Preference maxArchives=this.getPreferenceScreen().getPreference(4);
		for(i=0;i<values.length;i++) if (values[i].equals(sv)) break;
